...
public class VRegistrarEvaluacion extends JPanel{
    ...
    public WebSpinner spnParcia;
    public WebTextField tfCalificacion;
    ...
    public VRegistrarEvaluacion(){
        ...
        tfCalificacion = new WebTextField(15);
        ...
        JPanel pnlDatos = new JPanel(new MigLayout("wrap 2","0[]20[]0","20[]20[]25[]10"));
